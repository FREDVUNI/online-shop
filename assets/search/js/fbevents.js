			...
			return function(g, h, i, k) {
				...
				(function() {
					...
					function W(a, b, c) {
						...
						if (K.call(P, d)) {
							b != null && C(P[d].userData) ? (P[d].userData = e ? b || {} : {}, T.loadPlugin("identity")) : H({
								pixelID: d,
					...
					function ja(a, b, c) {
						b = b || {}, p.validateEventAndLog(a, b), a === "CustomEvent" && typeof b.event === "string" && (a = b.event), Y.call(this, a, b, c)
					}
					...
					function qa(a) {
						a.instance = S, a.callMethod = U, a._initHandlers = [], a._initsDone = {}, a.send = Z, a.getEventCustomParameters = la, a.addInitHandler = oa, a.getState = pa, a.init = W, a.set = V, a.loadPlugin = function(a) {
