function UET(o) {
	...
	this.loadConfig = function() {
		...
		f = "_uetmsdns";
		o.hasOwnProperty("msDnsCookie") && o.msDnsCookie && typeof o.msDnsCookie == "string" && (f = o.msDnsCookie);
		this.uetConfig.msDns = this.getCookie(f, "", 1) === "1";
		...
		this.postURL = r + "//" + this.domain + "/action/" + i;
		this.urlPrefix = this.postURL + "?";
		this.errPrefix = r + "//" + this.domain + "/action-err/" + i + "?";
		this.previewPrefix = r + "//" + this.domain + "/actionp/" + i + "?";
		o.Ver !== 1 ? (this.stringExists(o.tagId) && !this.stringExists(o.ti) && (o.ti = o.tagId), u = {
			ti: 0,
			Ver: 0,
			tm: 1,
			Tag: 0,
		...
		for (t in o) u.hasOwnProperty(t) && (this.beaconParams[t] = u[t] === 1 ? encodeURIComponent(o[t]) : o[t]);
	...
	this.dispatchq = function() {
		var n, t, i, r, f, e, u;
		for (this.evqDispatch = !0, ("onpagehide" in window) && (window.addEventListener("pageshow", this.firePageShow.bind(this)), window.addEventListener("pagehide", this.firePageHide.bind(this))), i = 0; i < this.evq.length; i++)
		...
		if (r = r !== !1, i = i || {}, this.uetConfig.disableAutoPageView === !0 && this.evqDispatch === !1 && this.dispatchq(), typeof i == "object") {
			if (this.uetConfig.allRep === !0 ? i.rep = "1" : i.hasOwnProperty("rep") && (i.rep === 1 || i.rep === "1" || i.rep === !0 ? i.rep = "1" : delete i.rep), r ? this.validateDataObject(n, i) : (i.event_action = t, i = this.validateDataObjectNew(n, i)), n === this.customEvt) {
				...
				if (s = !r && i.hasOwnProperty("page_path"), s) {
					if (i.spa = "Y", this.pageLoadDispatch === !1 ? (u = {}, u = this.addPageData(u, !1), this.stringExists(u.p) && (this.previousPage = u.p), i.r = u.r, i.lt = u.lt, u.hasOwnProperty("pt") && (i.pt = u.pt), u.hasOwnProperty("pn") && (i.pn = u.pn)) : (this.firePageHide(), this.beaconParams.mid = this.getGuid()), i.hasOwnProperty("page_title") && (i.tl = i.page_title, delete i.page_title), this.stringExists(this.previousPage)) {
			...
			this.addSessionId(this.beaconParams);
			i = this.addMsClkId(i);
	...
	this.addSessionId = function(n) {
		...
		var i = !0,
			t = this.getCookie(this.sessionCookieName, this.cookieValuePrefix, this.lengthSid);
		return this.stringExists(t) || (i = !1, t = this.getLocalStorageBackup(this.sessionCookieName, this.lengthSid)), this.stringExists(t) || (t = this.getGuid()), this.setCookie(this.sessionCookieName, t, this.sessionExpirationTime, i, !0, this.cookieValuePrefix, this.lengthSid), (this.getCookie(this.sessionCookieName, this.cookieValuePrefix, this.lengthSid) === t || this.getLocalStorageBackup(this.sessionCookieName, this.lengthSid) === t) && (n.sid = t), n
	};
	this.addMsClkId = function(n) {
		if (o.Ver < 2 || this.uetConfig.cookieAllowed === !1) return n;
		this.extractMsClkId(this.addUrlData({}));
		var i = "0",
			t = this.getCookie(this.msClkIdCookieName, this.cookieValuePrefix, this.lengthMsClkId);
		return this.stringExists(t) || (t = this.getLocalStorageBackup(this.msClkIdCookieName, this.lengthMsClkId)), this.stringExists(this.msClkId) ? t !== this.msClkId && (i = "1") : this.msClkId = t, this.stringExists(this.msClkId) ? (this.setCookie(this.msClkIdCookieName, this.msClkId, this.msClkIdExpirationTime, !0, !0, this.cookieValuePrefix, this.lengthMsClkId), this.getCookie(this.msClkIdCookieName, this.cookieValuePrefix, this.lengthMsClkId) !== this.msClkId && (i += "N"), n.msclkid = encodeURIComponent(this.msClkId + "-" + i)) : n.msclkid = "N", n
	};
	...
	this.firePageShow = function(n) {
		n && n.persisted && this.fireSendBeacon("pageShow")
	};
